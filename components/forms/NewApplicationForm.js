...
export default function NewApplicationForm({ data, submitForm, isLoading, setOpen }) {
                ...
                <div className="grid grid-cols-12 gap-6 mb-20">
                    <div className="col-span-12">
                        ...
                        <input
                            ...
                            name="appName"
                            id="appName"
                            autoComplete="application-address"
                    ...
                    <div className="col-span-12">
                        ...
                        <InputMask mask='9.99' alwaysShowMask='false' value={version} onChange={(e) => setVersion(() =>  e.target.value)}>
                       { (inputProps) => <input
                           {...inputProps} 
                            type="text"
                            name="version"
                            id="version"
                            autoComplete="application-version"
                            className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                        />}
                        </InputMask>
                    </div>
